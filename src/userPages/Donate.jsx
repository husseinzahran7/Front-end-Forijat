    ...
    <Box sx={{ p: 4, my: 4, direction: "rtl" }}>
      ...
      <Card>
        ...
        <Box sx={{ p: 2 }}>
          ...
          <Typography variant="body2">عليه ميزلي 14745 ريال</Typography>
        </Box>
        <Divider />
        <Box sx={{ p: 2 }}>
          <Typography variant="body2">
            الجنسية: سعودي | المبلغ المتبرع به: 14,745 رياض
          </Typography>
          <Typography variant="body2">الرقم التعريفي: 199948820</Typography>
        </Box>
      </Card>
    </Box>
  );
